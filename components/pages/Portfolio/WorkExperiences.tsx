...
const subQueryWork = [
  'Lead the development of Airdrop dApp and SubQuery Explorer dApp: from front-end to data layer,resulting in definite performance improvement and on-time delivery.',
